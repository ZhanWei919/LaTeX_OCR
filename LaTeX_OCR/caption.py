...
if __name__ == '__main__':
    ...
    parser.add_argument('--img', '-i', default='./data/small/images/images_train/TrainData2_15_sub_33.png',help='path to image')
    parser.add_argument('--model', '-m',default='BEST_checkpoint_CROHME.pth.tar', help='path to model')
    parser.add_argument('--word_map', '-wm', default='./data/small/vocab.json',help='path to word map JSON')
